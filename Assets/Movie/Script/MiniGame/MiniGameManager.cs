...
public class MiniGameManager : Manager<MiniGameManager> , IQuestionAnsweredCallback
{
    ...
    public void PlayPackage(PackageModel package, UserPackage userPackage) {
        ...
        Dictionary<ICapitalCurrency, int> costs = MiniGameManager.GetPackagePlayCost(this.activePackage,this.activeUserPackage);
    ...
    public void OnLevelUp() {
        ...
        foreach(PackageModel p in pkgsToActivate) {
            ...
            KiwiCommonDatabase.DataHandler.wrapper.userPackages.Add(userPackage);
