...
[Serializable]
public class PackageModel : BaseDbModel, SgFirebaseDataInitialiser.IFireBaseModel<string>
//, ICurrencyCost<ICurrencyUpdate>, ICurrencyReward<ICurrencyUpdate>
{
    ...
    [PrimaryKey]
    [JSONItem("_id", typeof(string))]
    public string _id;//{get; set;}
    [JSONItem("name", typeof(string))]
    public string name;// {get; set;}
    [JSONItem("logo", typeof(string))]
...
{
    public List<PackageModel> models;
}