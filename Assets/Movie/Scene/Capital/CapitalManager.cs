...
public class CapitalManager : Manager<CapitalManager>
{
    ...
    {
        transform.parent.gameObject.BroadcastMessage("DependencyCompleted", ManagerDependency.CURRENCY_INIT);
    ...
    virtual public void Load()
    {
        ...
        UserCurrency userCurrency = SgFirebase.GetInstance().dataInitialiser.userResources;
    ...
    virtual public int Silver
    {
        get
        {
            return GetCurrencyValue(CurrencyModel.CURRENCY_SILVER);
        }
        protected set
        {
            SetCurrencyValue(CurrencyModel.CURRENCY_SILVER, value);
        }
    }
    ...
    public void SaveCurrency()
    {
        ...
        SgRemoteAction.UpdateCurrencyAction(currencies, null);
    }
