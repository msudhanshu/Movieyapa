...
public interface IGrid
{
	 ...
	 */ 
	Vector3 GridPositionToArenaPosition(GridPosition position);
	
	Vector3 GridPositionToArenaPosition(GridPosition position, List<GridPosition> shape);
	
	/**
	 * Returns grid position nearest to the world coordiantes
	 */ 
	GridPosition ArenaPositionToGridPosition(Vector3  position);
