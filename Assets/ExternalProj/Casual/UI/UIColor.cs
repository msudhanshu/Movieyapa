...
public class UIColor
{
	...
	public static Color GetColourForActivityType(string type) {
		switch (type) {
			case StateTransitionType.GATHER :	return GATHER;
			case StateTransitionType.CLEAR :	return GATHER;
			case StateTransitionType.CONSTRUCT :	return BUILD;
			case StateTransitionType.RECRUIT :	return RECRUIT;
		}
		return Color.white;
	}
