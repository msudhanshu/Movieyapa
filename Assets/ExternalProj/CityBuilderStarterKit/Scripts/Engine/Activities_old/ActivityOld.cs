...
public class ActivityOld
{
	 ...
	 */ 
	public ActivityOld(string type, int durationInSeconds, System.DateTime startTime, string supportingId) {
		Type = type;
	 ...
	 * Create a new activity and populate with the supplied values.
	 */ 
	public ActivityOld(string type, int durationInSeconds, System.DateTime startTime, List<string> supportingIds) {
		Type = type;
		DurationInSeconds = durationInSeconds;
		StartTime = startTime;
		EndTime = startTime + new System.TimeSpan(0,0, durationInSeconds);
